...
public class MainActivity extends BaseActivity
    ...
    private void loadStringLogin() {
        ...
        if (com.dublikunt.nclient.settings.Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, com.dublikunt.nclient.settings.Login.getUser().getUsername()));
        else
            loginItem.setTitle(com.dublikunt.nclient.settings.Login.isLogged() ? R.string.logout : R.string.login);
    ...
    private void useDataSearchMode(@NonNull Uri data, @NonNull List<String> datas) {
        ...
        if (favorite) {
            if (com.dublikunt.nclient.settings.Login.isLogged()) useFavoriteMode(page);
            else {
    ...
    protected void onResume() {
        super.onResume();
        com.dublikunt.nclient.settings.Login.initLogin(this);
        ...
        builder
            ...
            .setPositiveButton(R.string.ok, (dialog, which) -> {
                for (GenericGallery g : inspector.getGalleries())
                    DownloadGallery.downloadGallery(MainActivity.this, g);
            });
        builder.show();
    }
