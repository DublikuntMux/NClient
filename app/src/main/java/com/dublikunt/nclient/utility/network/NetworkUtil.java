package com.dublikunt.nclient.utility.network;
...
public class NetworkUtil {
    ...
    private static ConnectionType getConnectivityPreLollipop(@NonNull ConnectivityManager cm) {
    ...
    private static ConnectionType getConnectivityPostLollipop(@NonNull ConnectivityManager cm, Network network) {
