...
public class NetworkUtil {
    ...
    private static ConnectionType getConnectivity(@NonNull ConnectivityManager cm, Network network) {
    ...
    public static void initConnectivity(@NonNull Context context) {
        ...
        ConnectivityManager.NetworkCallback callback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(@NonNull Network network) {
                ...
                setType(getConnectivity(cm, network));
            }
        };
        try {
            ...
            if (networks.length > 0)
                setType(getConnectivity(cm, networks[0]));
