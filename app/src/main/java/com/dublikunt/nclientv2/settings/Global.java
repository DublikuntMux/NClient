...
public class Global {
    ...
    public static int getDeviceWidth(@Nullable AppCompatActivity activity) {
        getDeviceMetrics(activity);
        return lastDisplay.widthPixels;
    }

    public static int getDeviceHeight(@Nullable AppCompatActivity activity) {
        getDeviceMetrics(activity);
        return lastDisplay.heightPixels;
    }

    private static void getDeviceMetrics(AppCompatActivity activity) {
        if (activity != null)
