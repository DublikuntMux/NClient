...
import com.dublikunt.nclientv2.api.enums.ApiRequestType;
import com.dublikunt.nclientv2.api.enums.Language;
import com.dublikunt.nclientv2.api.enums.SortType;
...
public class MainActivity extends BaseActivity
    ...
    private void setActivityTitle() {
        switch (modeType) {
            ...
            case TAG:
                ...
                break;
            case NORMAL:
                getSupportActionBar().setTitle(com.franmontiel.persistentcookiejar.R.string.app_name);
                break;
            default:
    ...
    private void initializeNavigationView() {
        ...
        onlineFavoriteManager.setVisible(com.dublikunt.nclientv2.settings.Login.isLogged());
    }
    ...
    private void loadStringLogin() {
        ...
        if (com.dublikunt.nclientv2.settings.Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, com.dublikunt.nclientv2.settings.Login.getUser().getUsername()));
        else
            loginItem.setTitle(com.dublikunt.nclientv2.settings.Login.isLogged() ? R.string.logout : R.string.login);
    ...
    private void useDataSearchMode(Uri data, List<String> datas) {
        ...
        if (favorite) {
            if (com.dublikunt.nclientv2.settings.Login.isLogged()) useFavoriteMode(page);
            else {
    ...
    protected void onResume() {
        super.onResume();
        com.dublikunt.nclientv2.settings.Login.initLogin(this);
